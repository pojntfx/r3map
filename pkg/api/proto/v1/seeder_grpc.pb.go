...
const (
	Seeder_ReadAt_FullMethodName = "/com.pojtinger.felicitas.r3map.v1.Seeder/ReadAt"
	Seeder_Size_FullMethodName   = "/com.pojtinger.felicitas.r3map.v1.Seeder/Size"
	Seeder_Track_FullMethodName  = "/com.pojtinger.felicitas.r3map.v1.Seeder/Track"
	Seeder_Sync_FullMethodName   = "/com.pojtinger.felicitas.r3map.v1.Seeder/Sync"
	Seeder_Close_FullMethodName  = "/com.pojtinger.felicitas.r3map.v1.Seeder/Close"
)
...
func (c *seederClient) Track(ctx context.Context, in *TrackArgs, opts ...grpc.CallOption) (*TrackReply, error) {
	out := new(TrackReply)
	err := c.cc.Invoke(ctx, Seeder_Track_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seederClient) Sync(ctx context.Context, in *SyncArgs, opts ...grpc.CallOption) (*SyncReply, error) {
	out := new(SyncReply)
	err := c.cc.Invoke(ctx, Seeder_Sync_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seederClient) Close(ctx context.Context, in *CloseArgs, opts ...grpc.CallOption) (*CloseReply, error) {
	out := new(CloseReply)
	err := c.cc.Invoke(ctx, Seeder_Close_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Seeder_ReadAt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seeder_ReadAt_FullMethodName,
	}
...
func _Seeder_Track_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seeder_Track_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Seeder_Sync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seeder_Sync_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Seeder_Close_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Seeder_Close_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Seeder_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.pojtinger.felicitas.r3map.v1.Seeder",
